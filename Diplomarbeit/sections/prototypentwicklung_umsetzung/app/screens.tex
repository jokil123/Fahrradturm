\subsubsection{Screens}Zur besseren Übersichtlichkeit sind die Texte in der App im Gegensatz zu den Mockups in Englisch.
...
\end{figure}
\noindent Die Abbildung \ref{fig:screenhome} zeigt links die Ansicht ohne Anmeldung und rechts die Ansicht mit Anmeldung.
...
\noindent Diese Infos werden über die Navigation übergeben.
...
\noindent Bei der Code-Auflistung \ref{lst:navigation} wird gezeigt, wie man von der Komponente Box zum aktuellen Screen navigiert wird. Dort wird das \Gls{Array} boxinfo übergeben.
...
\noindent Wie bei der Code-Auflistung \ref{lst:zugriff}, wird beim aktuellen Screen nun die Variable Box mithilfe von route.params abgerufen.
...
\end{figure}
\noindent Die Abbildung \ref{fig:screenboxinfo} zeigt links die Ansicht bei einer bereits vergangenen Buchung und rechts die Ansicht bei einer aktiven Buchung.
...
\noindent Die Abbildung links zeigt die Ansicht, wenn die anwendende Person nicht angemeldet ist. Bei der Abbildung rechts sieht man, dass mehrere Einstellungen zum Account angezeigt werden, falls die anwendende Person eingeloggt ist.
...
\noindent Dabei wird die Methode signInWithEmailAndPasswort des Authentizierungs-Service auth von Firebase verwendet. Es werden die eingegebene E-Mail und Passwort übergeben. Bei einer erfolgreichen Anmeldung bekommt die anwendende Person die Meldung „signed in“ und wird zum Screen „Settings“ zurückgeleitet.
\noindent Beim Klicken auf den Button „Register“ wird man zur Seite „SignIn“ geführt.

\begin{figure}[H]
  \centering
  \includegraphics[width=0.30\textwidth]{images/app-screenshots/screenlogin.png}
...
\noindent Falls die Erstellung des Accounts nicht möglich ist, wird eine entsprechende Fehlermeldung ausgegeben.
...
\noindent Anschließend werden alle Marker auf der Karte angezeigt. Die Funktion MarkerImage liefert entweder einen grünen Marker, falls noch Plätze frei sind, oder einen grauen Marker, wenn es keine freien Plätze für Fahrräder gibt. Beim Klicken auf einen Marker, kommt man zum Screen „TowerInfo“.
...
\noindent Die Abbildung links zeigt die Karte, wenn die Türme noch nicht aus der Datenbank geladen sind.
...
\noindent Falls man nicht angemeldet ist:
\begin{itemize}
...
\noindent Falls man angemeldet ist:
\begin{itemize}
  \item Möglichkeit zum Lagern von Fahrrad oder Gegenstand
  \item Gegenstände, die im Turm gelagert sind (Komponente Box)
\end{itemize}

\noindent Mit einem Klick auf das Aktualisieren-Symbol auf der rechten oberen Ecke, werden die aktuellen Daten des Turmes von der Datenbank abgerufen.
...
\noindent Wie bei der Abbildung \ref{fig:assignmentsze} ersichtlich, gibt es nach dem Überprüfen des Standorts mehrere Szenarien. Je nach Art der Anfrage und Antwort des Controllers wird dem User etwas anderes angezeigt.

\begin{figure}[H]
  \centering
  \includegraphics[width=0.3\textwidth]{images/app-screenshots/waitinga.png}
  \includegraphics[width=0.3\textwidth]{images/app-screenshots/waitingb.png}
  \caption{Senden der Anfrage zum Aus-/Einlagern}
  \label{fig:screenwaiting}
\end{figure}


\noindent Abbildung \ref{fig:screenwaiting}: Beim Senden der Anfrage kommt die Nachricht „Waiting for an available space“ beim Einlagern und beim Auslagern die Nachricht „Waiting for bike to store out“.

\begin{figure}[H]
  \centering
  \includegraphics[width=0.3\textwidth]{images/app-screenshots/recieved.png}
  \includegraphics[width=0.3\textwidth]{images/app-screenshots/error.png}
  \caption{JobRecieved}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.3\textwidth]{images/app-screenshots/succes.png}
