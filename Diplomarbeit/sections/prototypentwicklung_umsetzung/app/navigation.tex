...
\paragraph{TabNavigator} Der TabNavigor ist die Navigationsleiste unten am Bildschirm. Damit kann die anwendenden Person zwischen verschiedenen Ansichten wechseln. Die Ansicht, auf der man sich gerade befindet, wird mit einem Farbton hervorgehoben. Die Abbildung \ref{fig:bottomtab} zeigt den BottomTab der entwickelten App. \citev{tabnavigator} \\
\begin{figure}[H]
    \centering
