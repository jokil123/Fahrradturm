...
\paragraph{TabNavigator} Der TabNavigor ist die Navigationsleiste unten am Bildschirm. Damit kann die anwendende Person zwischen verschiedenen Ansichten wechseln. Die Ansicht, auf der man sich gerade befindet, wird mit einem Farbton hervorgehoben. Die Abbildung \ref{fig:bottomtab} zeigt den BottomTab der entwickelten App. \citev{tabnavigator}
...
Die Navigation der App besteht aus einem BottomTabNavigator. Dieser führt zu vier verschiedenen \Gls{StackNavigator}:
