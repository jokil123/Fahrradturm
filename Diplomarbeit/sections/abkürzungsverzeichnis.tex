...
\begin{acronym}
  ...
  \acro{SDK}{Software"=Entwicklungskit}{Ein Software Entwicklungskit(Software Development Kit) ist eine Sammlung von Programmierwerkzeugen und Programmbibliotheken, die zur Entwicklung von Software dient \citev{sdk}}
  \acro{CAD}{Konstruktionsprogram}{Computer Aided Design}
  \acro{CAM}{computergestützte Fertigung}{Computer Aided Manufacturing}
  ...
  % \acro{JSX}{JavaScript Syntax Extension}{JSX ermöglicht es uns, HTML-Elemente in JavaScript zu schreiben ohne die Methoden createElement() oder appendChild() zu verwenden.\citev{jsx}}
  \acro{ER}{Entity Relation}
\end{acronym}

% definiert Ausnahmen für Mehrzahl
\acrodefplural{SBC}[SBCs]{Einplatinencomputer}
% This is such a hack lol
\acrodefplural{CAM}[CAM]{computergestützten Fertigung}