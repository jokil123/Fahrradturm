...
\newglossaryentry{StackNavigator}{
  name=StackNavigator,
description={Ein StackNavigator ist eine Art der Navigation in einer App. Dabei werden die verschieden Ansichten aufeinander „gestapelt und die anwendende Person kann vor und zurück navigieren.“ \citev{stacknavigator}}
}
