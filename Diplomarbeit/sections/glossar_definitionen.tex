...
\newglossaryentry{Framework}{
  name=Framework,
  description={„Ein Framework ist eine Ansammlung von Werkzeugen, vorgefertigten Features in Form von Code-Schnipseln und Regeln, welche dabei helfen sollen, Softwareprojekte schneller umzusetzen.“\cite{framework}}
}
