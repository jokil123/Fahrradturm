...
\newglossaryentry{Fahrraddurchsatz}{
  name=Fahrraddurchsatz,
  description={Der Fahrraddurchsatz ist die Anzahl der Fahrräder, die ein Lagersystem pro Stunde Ein- und Auslagert.}
}
