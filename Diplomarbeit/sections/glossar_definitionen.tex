...
\newglossaryentry{Open-Source}{
  name=Open-Source,
<<<<<<< Updated upstream
  description={Open-Source ist ein Software-Entwicklungsmodell, bei dem der Quellcode öffentlich ist und von jeder Person gratis weiterentwickelt und genutzt werden kann. \citev{opensource}}
}
=======
