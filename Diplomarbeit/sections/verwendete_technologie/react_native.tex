...
React Native verwendet Elemente wie zum Beispiel <Text> um Text darzustellen oder <Image> für ein Bild. Diese Elemente werden in den nativen Code der Android- oder iOS-App umgewandelt. \citev{reactnative} \\
\begin{figure}[H]
    \centering
