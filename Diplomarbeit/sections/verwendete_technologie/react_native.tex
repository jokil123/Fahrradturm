\subsection{React Native} \label{reactnative}
React Native ist ein open-source Software Framework, das von Meta erstellt wurde. Es ermöglicht die Entwicklung von nativen mobilen Anwendungen für verschiedene Betriebssysteme (Android, iOS, Windows, macOS, …) mit einer gemeinsamen Codebasis. React Native wird von vielen bekannten Unternehmen, wie zum Beispiel Meta oder Microsoft zur Entwicklung von Apps verwendet.\\
React Native verwendet Elemente wie zum Beispiel <Text> um Text darzustellen oder <Image> für ein Bild. Diese Elemente werden in den nativen Code der Android- oder iOS-App umgewandelt. \cite{reactnative} \\
\begin{figure}[H]
    \centering
    \includegraphics[width=0.2\textwidth]{images/reactnativelogo.png}
    \caption{React Naive Logo\cite{reactnative}}
